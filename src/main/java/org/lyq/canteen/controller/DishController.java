...
import org.lyq.canteen.service.DishService;
...
public class DishController {
    ...
    public R<String> delete(String ids) {
        // 获取前段传过来的ids 存在String【】
        String[] idList = ids.split(",");
        // 将String【】 转换成List<Long>
        List<Long> dishIds = Arrays.stream(idList)
                .map(s -> Long.parseLong(s.trim())).collect(Collectors.toList());
        log.info(idList.toString());
        Boolean bol = dishService.deleteWithFlavor(dishIds);
